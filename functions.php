...
// extra user fields
add_action( 'show_user_profile', 'kilobyte_show_extra_profile_fields' );
add_action( 'edit_user_profile', 'kilobyte_show_extra_profile_fields' );

function kilobyte_show_extra_profile_fields( $user ) { ?>
...
add_action( 'personal_options_update', 'kilobyte_save_extra_profile_fields' );
add_action( 'edit_user_profile_update', 'kilobyte_save_extra_profile_fields' );

function kilobyte_save_extra_profile_fields( $user_id ) {
